...
\end{itemize}
Eine Datei, die mit \texttt{fopen} geöffnet wurde, muss mit der Funktion \texttt{fclose} wieder geschlossen werden:\index{\texttt{fclose}}, die folgende Definition hat:
\begin{lstlisting}
...
Dies kann man in C beispielsweise mit den Funktione \texttt{fread} und \texttt{fwrite} bewerkstelligen:\index{\texttt{fread}}\index{\texttt{fwrite}}
\begin{lstlisting}

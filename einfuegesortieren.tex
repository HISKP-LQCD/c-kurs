...
void sort(int sortiert[], int unsortiert[], const int n);
\end{lstlisting}
In diesen beiden header Dateien ist das sogenannte Pragma \texttt{#pragma once} hinzugekommen.\index{\texttt{#pragma once}}
...
In diesem Schritt wird dann die Deklaration in \texttt{main.o} mit den Definitionen in \textt{read.o} und \texttt{sort.o} verknüpft.

...
\begin{mydefinitionblock}{Definition: \texttt{Heap}}
...
\end{lstlisting}
\begin{mydefinitionblock}{Strichwörter: \texttt{break} und \texttt{continue}}
\begin{itemize}
...
%\begin{mydefinitionblock}{Function definition \texttt{printf}}
